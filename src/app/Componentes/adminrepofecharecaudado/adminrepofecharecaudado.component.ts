...
@Component({
  selector: 'app-adminrepofecharecaudado',
  templateUrl: './adminrepofecharecaudado.component.html',
  styleUrls: ['./adminrepofecharecaudado.component.css']
})
export class AdminrepofecharecaudadoComponent implements OnInit {
