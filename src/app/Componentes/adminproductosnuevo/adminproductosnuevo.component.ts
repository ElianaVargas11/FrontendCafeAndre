...
@Component({
  selector: 'app-adminproductosnuevo',
  templateUrl: './adminproductosnuevo.component.html',
  styleUrls: ['./adminproductosnuevo.component.css']
})
export class AdminproductosnuevoComponent implements OnInit {
