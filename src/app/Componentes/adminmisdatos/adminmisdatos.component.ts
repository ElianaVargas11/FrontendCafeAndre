...
@Component({
  selector: 'app-adminmisdatos',
  templateUrl: './adminmisdatos.component.html',
  styleUrls: ['./adminmisdatos.component.css']
})
export class AdminmisdatosComponent implements OnInit {
