...
@Component({
  selector: 'app-adminreportediario',
  templateUrl: './adminreportediario.component.html',
  styleUrls: ['./adminreportediario.component.css']
})
export class AdminreportediarioComponent implements OnInit {
